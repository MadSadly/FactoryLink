...
CREATE TABLE recommendation_feedback (
  id INT PRIMARY KEY AUTO_INCREMENT,
  query_company_id BIGINT NOT NULL,        -- 추천을 요청한 업체 (companies.id FK)
  recommended_company_id BIGINT NOT NULL,  -- 추천받은 업체 (companies.id FK)
...
CREATE TABLE quotes (
  ...
  requester_company_id BIGINT NOT NULL,    -- 견적 요청 업체 (companies.id FK)
  target_company_id BIGINT NOT NULL,       -- 견적 대상 업체 (companies.id FK)
...
CREATE TABLE contract_drafts (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
  quote_id BIGINT NOT NULL,               -- quotes.id FK
